...
batch_size = 75 # in each iteration, we consider 32 training examples at once
...
result = model.evaluate(X_test, Y_test, verbose=1) # Evaluate the trained model on the test set!
